<?php
class ITRSW_FREE_Dependency_Checker {
	 ...
	 *
	 * @throws ITRSW_FREE_Missing_Dependencies_Exception
	 */
	public function check() {
		$missing_plugins = $this->get_missing_plugins_list();
		if ( ! empty( $missing_plugins ) ) {
			throw new ITRSW_FREE_Missing_Dependencies_Exception( $missing_plugins );
		}
	}
